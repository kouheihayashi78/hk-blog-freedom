...
export const metadata = {
  title: "About | HK Blog",
  description: "About me, my skills, and my achievements.",
};

export default function AboutPage() {
  return (
    <main className="container mx-auto px-4 py-12 max-w-3xl animate-fade-in-up">
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">K.H</h1>
      ...
      <section className="mb-12">
        ...
        <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed">
          <p className="mb-4">
            日々の学習の中で得た知見、気になった技術、ポエムなどを投稿したいが、
            QiitaやZennにあげる投稿は有益なものである必要があると勝手に感じておりました。
            個人的な技術メモや日記を書き散らしたく、このブログを開設しました。
          </p>
          <p>
            「シンプルで使いやすい」をモットーに、ユーザー体験を重視した開発を心がけています。
            モダンなフロントエンド技術に関心が高く、特にReact/Next.js周辺のエコシステムを好んで使用しています。
          </p>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="font-bold text-lg mb-3 text-gray-900">Backend & Others</h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-center">
